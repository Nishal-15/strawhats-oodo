...
export default function AdminDashboard({ user, logout, dashboard }) {
  ...
  return (
    <main className="page">
      ...
      <section className="hero">
        ...
        <p className="muted">
          Manage the complete ERP and monitor every business operation.
        </p>
      </section>
      ...
      <section className="grid">
        ...
        <Link className="card module" to="/stock-ledger">
          <span className="module-number">02</span>
          <h3>Stock Ledger</h3>
          <p>View the complete inventory movement history.</p>
        </Link>

        <div className="card module">
          <span className="module-number">03</span>
          <h3>Sales</h3>
          <p>Manage customers and sales orders.</p>
        </div>
        ...
        <div className="card module">
          <span className="module-number">05</span>
          <h3>Manufacturing</h3>
          <p>Manage BoM and production operations.</p>
        </div>

        <div className="card module">
          <span className="module-number">06</span>
          <h3>User Management</h3>
          <p>Manage ERP users and their roles.</p>
        </div>
      </section>
